...
내보내기 일정은 환경 상태에 따라 다릅니다. 예약된 내보내기가 시작되어야 할 때 진행중인 [종속성](system.md#refresh-policies)에 대한 업데이트가 있는 경우 시스템은 먼저 종속성을 완료한 다음 내보내기를 실행합니다. **새로 고침** 열에서 내보내기가 마지막으로 새로 고쳐진 시기를 확인할 수 있습니다.
